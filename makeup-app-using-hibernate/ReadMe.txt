Makeup artist application using hibernate

This is a multi module web application developed using springboot, spring MVC, thymeleaf, hibernate, maven.
It provides options to book appointments, view booked appointments, cancel appointments, view portfolio, view rates, contact information, services of the make-up artist.

This application is similar to Makeup artist application. Have used hiberanate in this application and added the functionality to cancel appointments.
...
For using application in english use url: http://localhost:8080/login or http://localhost:8080/login?locale=en
